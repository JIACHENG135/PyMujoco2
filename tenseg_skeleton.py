...
class tenseg_skeleton(object):
    ...
    def __init__(self,data_name):
        ...
        Geom = geom(name="floor",pos="0 0 -5",size="0 0 1",type="plane",material="matplane")
...
#     </body> -->
    ...
    <option timestep="0.01" integrator="RK4" gravity = "0 0 -9" collision="dynamic" density="1"/>
    ...
    def _addstr(self):
        ...
        for i in range(ns):
            ...
            tmps = spatial(name = 'S' + str(self.strcounter),width = '0.02',stiffness = '20000')
            self.strcounter += 1
    ...
    def _addbar(self):
        ...
        for i in range(n):
            ...
            # if start not in 
                # globalk = pos + k
                # if k== '0 0 0 ':
            if str(start)[1:-1] not in site_set:
                # print(str(start))
                site_set.add(str(start)[1:-1])
        ...
        print(len(list(site_set)))
        for i in range(len(list(site_set))):
            print(list(site_set)[i])
